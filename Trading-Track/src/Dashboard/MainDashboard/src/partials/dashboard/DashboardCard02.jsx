  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
      <div className="px-5 pt-5">
        ...
        <h2 className="text-lg font-semibold text-slate-800 mb-2">Overall Progress</h2>
        <div className="text-xs font-semibold text-slate-400 uppercase mb-1">Profit</div>
